...
**Phase B (Emergent, wk 3–6):** import the repo; Emergent builds the commodity surface — onboarding screens, org-chart animation player, role-card deck, approval-queue UI, Charter editor, dashboard, Stripe billing, notifications. **CODEOWNERS lock:** Emergent never merges into router/vault/gate/queue.
