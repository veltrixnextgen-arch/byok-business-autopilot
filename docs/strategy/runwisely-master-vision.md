...
| Roles → agents with full metadata | **Mostly built.** Role, objective, tasks, tier, cadence, tools, permissions, budget, approval requirements all exist. Memory and escalation rules are thinner. |
